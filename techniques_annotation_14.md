...
1）知識（他の方法では得られない類の）を得るため──たとえば「フリーダおばさん、あの世ってどんな感じなの？」と尋ねるようなことから、特定の薬草について、その癒しの精霊に教えてもらおうとするような知識を含む。ときには、内的世界の特定の領域を旅して、特定の存在と接触する、というような形を取ることもある。

2）能力を強化するため──戦の神を憑依させて戦闘力を高めるなどの方法で、他の精霊に対する一時的な支配権が得られることがある。たとえば私のクライアントのひとりは、喉の不調をひんぱんに訴えていた。軽い「視覚的」トランス状態で彼女を観察すると、膨れ上がったヒキガエルのような存在が喉に巣くっていた。それを無理やり追い出すのは難しかった。私の盟友たちが（これもトランス中に）教えてくれたのは、その霊に効力を持つのは「もっと大きなカエル」だけだということだった。そこで、私は自分がヒキガエルの精霊に憑依される儀式を行い、クライアントの喉にいる存在と交渉した。

3）共同的なエクスタシーを得るため──シャーマンは、部族やコミュニティにとって極めて重要な役割を担っている。日常世界と神話や共同記憶の巨大な世界との間を仲介する必要があるからだ。シャーマンは神話的儀式への参加者となり、他者をそこに導く。シャーマンは、コミュニティの神話宇宙の「秘密の経路」を案内するガイドなのだ。この文化的役割を担う上で最大の障害となるのは、西洋社会が持つあまりにも複雑で雑多な神話的なイメージである。
...
4）つながり（Connectivity）を得るため──異なる概念や、対象のあいだにリンクを見つけ出して、新たなアイデアや熱意の奔流を生み出す。私は、スランプ（＝書けない状態）を抜けたいときと思うと、よくトランスに入る。断片的な会話、詩、映像が、内なる視野を横切るのをただ見守るのだ。すると何かが内側から湧き上がってくる。そして、磁石に吸い寄せられる鉄粉のようにアイデアやつながりが浮かび上がる。

5）能力を実証するため──現代の文化においては、たとえばカレドン・ナッデアの著作をすべて読破したといえば、シャーマンとして人を感心させることができるかもしれない。しかし修行中のシャーマンは、トランス状態に到達できることを、実地で示さねばならないことがある。精霊たちはしばしば、極度の精神的プレッシャーを与えてくる。これは「冥界イニシエーション」の圧縮版とも言えるものだ。いくつかの霊や神は、こちらを狂わせようとしてくる──その試練を乗り越えたときに、ようやく知恵を授けてくれる。幻覚性物質の霊たちは、特にその傾向が強い（この話はまた別の機会にしよう）。
